...
app.controller('switchBtnCtrl', ['$scope', '$window', '$location', function($scope, $window, $location) {
  $scope.btnSwitch = function() {
    //  var field = 'prAwardYr';
...
app.controller('paginationCtrl', ['$scope', '$filter', function ($scope, $filter) {
  {
      ...
      $scope.getData = function () {
        ...
        return $filter('filter')($scope.data, $scope.codes)
       /*
         // manual filter
...
app.controller('dragDropCtrl', ['$scope', '$window', '$localStorage', '$location', function($scope, $localStorage, $window, $location) {
